<div id="patient-login-table-wrapper" class="table-responsive d-none">
    <table id="patient-login-table" class="table table-vcenter w-100" data-server-side="true">
        <thead>
            <tr>
                <th>IP Address</th>
...
<div id="patient-login-loader" class="d-flex justify-content-center align-items-center py-4">
    ...
    if (typeof jQuery !== 'undefined') {
        $('#patient-login-table').DataTable({
            ...
            initComplete: function () {
                $('#patient-login-loader').remove();
                $('#patient-login-table-wrapper').removeClass('d-none');
            }
        });
    }
</script>
