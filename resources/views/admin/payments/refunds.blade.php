...
@section('content')
    ...
    <div class="card shadow-sm">
        ...
        {{-- Body --}}
            {{-- Loading Spinner --}}
            <div id="refunds-loader" class="d-flex justify-content-center align-items-center py-5">
                <div class="spinner-border text-primary" role="status">
                    <span class="visually-hidden">Loading…</span>
                </div>
            </div>

            <div id="refunds-table-wrapper" class="table-responsive d-none">
                <table
                    id="refunds-table"
