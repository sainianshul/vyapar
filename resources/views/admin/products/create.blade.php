                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" 
                                value="{{ old('title') }}" required placeholder="Enter product title">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                rows="5" required placeholder="Product description">{{ old('description') }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="price_unit" class="form-select @error('price_unit') is-invalid @enderror">
                                    ...
                                    @foreach (\App\Models\Product::getPriceUnitsList() as $value => $label)
                                        <option value="{{ $value }}" {{ old('price_unit') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                @foreach (\App\Models\Product::getStatusList() as $value => $label)
                                    <option value="{{ $value }}" {{ old('status', \App\Models\Product::STATUS_ACTIVE) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="condition" class="form-select @error('condition') is-invalid @enderror" required>
                                @foreach (\App\Models\Product::getConditionList() as $value => $label)
                                    <option value="{{ $value }}" {{ old('condition', \App\Models\Product::CONDITION_NEW) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="minimum_quantity" class="form-control @error('minimum_quantity') is-invalid @enderror" 
                                value="{{ old('minimum_quantity', 1) }}" min="1" required>
