...
@section('content')
    ...
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                <x-breadcrumb :items="[
                    ['label' => 'System', 'url' => route('admin.system.communication-logs.index')],
    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    {{-- Channel Filter --}}
                    <select id="filter-channel" class="form-select" style="width: 160px;">
        ...
        <div class="card-body">
            ...
            {{-- Loading Spinner --}}
            <div id="communication-logs-loader" class="d-flex justify-content-center align-items-center py-5">
            ...
            {{-- Table --}}
            <div id="communication-logs-table-wrapper" class="table-responsive d-none">
                <table id="communication-logs-table" class="table table-vcenter w-100">
                    <thead>
                        <tr>
                            <th>User</th>
                            <th>Notification</th>
...
@push('datatables_js')
    ...
    <script>
        $(function () {
            // ── Init DataTable ────────────────────────────────────────────────
            let table = $('#communication-logs-table').DataTable({
                serverSide: true,
                processing: false,
                ajax: {
                ...
                language: {
                    ...
                    zeroRecords: ' ',
                    loadingRecords: ' ',
                    info: 'Showing _START_–_END_ of _TOTAL_ communication logs',
                    infoEmpty: 'No communication logs to show',
                ...
                initComplete: function () {
                    $('#communication-logs-loader').remove();
            ...
            // ── Filters ─────────────────────────────────────────────────────
            $('#filter-channel, #filter-status').on('change', function () {
                table.ajax.reload();
            });
            ...
            $('#btn-empty-logs').on('click', function () {
                Swal.fire({
                    ...
                    text: 'All communication logs will be permanently removed.',
                    icon: 'warning',
