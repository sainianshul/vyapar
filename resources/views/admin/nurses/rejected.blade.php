    ...
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Rejected Nurses</h2>
            </div>
            <div class="col-auto">
                <a href="{{ route('admin.nurses.index') }}" class="btn btn-outline-secondary">
                    <i class="ti ti-users me-1"></i>All Nurses
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap gap-3">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" id="dt-search" class="form-control" style="width: 260px;"
                        placeholder="Search rejected nurses..." />
                </div>
        ...
        $(function () {
            ...
            var table = $('#nurses-table').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: ' ',
                    loadingRecords: ' ',
                    info: 'Showing _START_–_END_ of _TOTAL_ rejected applications',
                    infoEmpty: 'No rejected applications to show',
