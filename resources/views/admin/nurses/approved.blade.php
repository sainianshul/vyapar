    ...
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Approved Nurses</h2>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap gap-3">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" id="dt-search" class="form-control" style="width: 260px;"
                        placeholder="Search approved nurses..." />
                </div>
        ...
        $(function () {
            ...
            var table = $('#nurses-table').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: ' ',
                    loadingRecords: ' ',
                    info: 'Showing _START_–_END_ of _TOTAL_ approved nurses',
                    infoEmpty: 'No approved nurses to show',
