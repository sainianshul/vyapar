...
@section('content')
    ...
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Edit Nurse: {{ $user->name }}</h2>
            </div>
            <div class="col-auto d-flex gap-2">
                <a href="{{ route('admin.nurses.index') }}" class="btn btn-outline-secondary">
                    <i class="ti ti-arrow-left me-1"></i>All Nurses
                </a>
                <a href="{{ route('admin.nurses.show', $user->id) }}" class="btn btn-outline-primary">
                    <i class="ti ti-eye me-1"></i>View Profile
                </a>
                <button type="submit" form="nurse-edit-form" class="btn btn-primary" id="btn-header-save">
    ...
    {{-- Main Wizard Form --}}
    <form id="nurse-edit-form" action="{{ route('admin.nurses.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card wizard-card" id="wizard-card">
            ...
            <div class="wizard-nav" id="wizard-nav">
                @php
                    $steps = [
                        ['title' => 'Personal', 'desc' => 'Profile & Contact', 'icon' => 'ti-user'],
            ...
            <div class="card-body py-4">
                ...
                <div class="step-pane active" id="pane-0" data-title="Personal Details" data-desc="Update identity details, contact information, and profile photo.">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="emergency_contact_phone" pattern="[0-9+]*" minlength="10" maxlength="15"
                                    ...
                                    value="{{ old('emergency_contact_phone', $user->nurseProfile->emergency_contact_phone ?? '') }}"
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                @if($user->profile_photo)
                                    <img id="avatar-preview" src="{{ Storage::url($user->profile_photo) }}" class="rounded-circle border" style="width: 44px; height: 44px; object-fit: cover;" alt="Profile Photo" />
                                @else
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea name="bio" class="form-control @error('bio') is-invalid @enderror" rows="3"
                                placeholder="Brief profile summary...">{{ old('bio', $user->nurseProfile->bio ?? '') }}</textarea>
                ...
                <div class="step-pane" id="pane-1" data-title="Location Details" data-desc="Specify street address and geographical coordinates.">
                    <div class="row g-3 mb-3">
                        <div class="col-12">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="address" class="form-control @error('address') is-invalid @enderror"
                                    value="{{ old('address', $user->nurseProfile->address ?? '') }}" required />
                            </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="city" class="form-control @error('city') is-invalid @enderror"
                                value="{{ old('city', $user->nurseProfile->city ?? '') }}" required />
                            @error('city') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label class="form-label required">State</label>
                            <input type="text" name="state" class="form-control @error('state') is-invalid @enderror"
                                value="{{ old('state', $user->nurseProfile->state ?? '') }}" required />
                            @error('state') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label class="form-label required">Country</label>
                            <input type="text" name="country" class="form-control @error('country') is-invalid @enderror"
                                value="{{ old('country', $user->nurseProfile->country ?? 'India') }}" required />
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="pincode" class="form-control @error('pincode') is-invalid @enderror"
                                value="{{ old('pincode', $user->nurseProfile->pincode ?? '') }}" required pattern="[0-9]*"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="latitude" class="form-control @error('latitude') is-invalid @enderror"
                                    value="{{ old('latitude', $user->nurseProfile->latitude ?? '0') }}" required />
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="longitude" class="form-control @error('longitude') is-invalid @enderror"
                                    value="{{ old('longitude', $user->nurseProfile->longitude ?? '0') }}" required />
                            </div>
                ...
                <div class="step-pane" id="pane-2" data-title="Education History" data-desc="Academic qualifications, nursing degrees, and educational institutions.">
                    ...
                    <div id="educations-container">
                        @php
                            ...
                            if ($oldEducations === null && $user->nurseProfile && $user->nurseProfile->educations) {
                                $oldEducations = $user->nurseProfile->educations->map(function($e) {
                                    return [
                                        'degree_name' => $e->degree_or_course ?? $e->degree_name ?? '',
                                        'institution_name' => $e->institute_name ?? $e->institution_name ?? '',
                                        'start_date' => $e->start_date ? \Carbon\Carbon::parse($e->start_date)->format('Y-m-d') : ($e->start_year ? $e->start_year . '-01-01' : ''),
                                        'end_date' => $e->end_date ? \Carbon\Carbon::parse($e->end_date)->format('Y-m-d') : ($e->end_year ? $e->end_year . '-01-01' : ''),
                                    ];
                                })->toArray();
                            }
                            if (empty($oldEducations)) {
                                $oldEducations = [[]];
                            }
                        @endphp
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end">
                                        ...
                                        @if(isset($edu['id']) && $edu['id'])
                                            <button type="button" class="btn btn-outline-danger remove-edu w-100" data-id="{{ $edu['id'] }}" title="Remove"><i class="ti ti-trash me-1"></i>Remove</button>
                                        @else
                ...
                <div class="step-pane" id="pane-3" data-title="Work Experience" data-desc="Past clinical experiences, hospital affiliations, and professional roles.">
                    <div class="d-flex align-items-center justify-content-end mb-3">
                    ...
                    <div id="experiences-container">
                        @php
                            ...
                            if ($oldExperiences === null && $user->nurseProfile && $user->nurseProfile->workHistories) {
                                $oldExperiences = $user->nurseProfile->workHistories->map(function($w) {
                                    return [
                                        'id' => $w->id ?? null,
                                        'designation' => $w->role_or_position ?? $w->designation ?? '',
                                        'hospital_name' => $w->organization_name ?? $w->hospital_name ?? '',
                                        'start_date' => $w->start_date ? \Carbon\Carbon::parse($w->start_date)->format('Y-m-d') : '',
                                        'end_date' => $w->end_date ? \Carbon\Carbon::parse($w->end_date)->format('Y-m-d') : '',
                                        'is_currently_working' => $w->is_currently_working ?? false,
                                    ];
                                })->toArray();
                            }
                            if (empty($oldExperiences)) {
                                $oldExperiences = [[]];
                            }
                        @endphp
                                    ...
                                    <div class="col-md-4 d-flex flex-column justify-content-end">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            @if(isset($exp['id']) && $exp['id'])
                                                <button type="button" class="btn btn-outline-danger remove-exp flex-grow-1" data-id="{{ $exp['id'] }}" title="Remove"><i class="ti ti-trash me-1"></i>Remove</button>
                                            @else
                ...
                {{-- STEP 4: Documents --}}
                <div class="step-pane" id="pane-4" data-title="Verification Documents" data-desc="Review current documents and upload new certificates or IDs.">

                    {{-- Existing Documents Table --}}
                    @if($user->nurseProfile && $user->nurseProfile->documents->count() > 0)
                        <div class="mb-4">
                            <label class="form-label fw-bold">Existing Uploaded Documents</label>
                                            ...
                                            <tr id="doc-row-{{ $doc->id }}">
                                                ...
                                                <td>
                                                    @if($doc->status == \App\Models\NurseDocument::STATUS_APPROVED)
                                                        <span class="badge bg-green-lt"><i class="ti ti-check me-1"></i>Approved</span>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="{{ route('admin.nurses.document', $doc->id) }}" target="_blank"
                                                        class="btn btn-icon btn-sm btn-outline-primary me-1" title="View Document">
                                                        <i class="ti ti-eye"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-icon btn-sm btn-ghost-danger remove-existing-doc"
                                                        data-id="{{ $doc->id }}" title="Remove">
                    ...
                    <label class="form-label fw-bold">Upload / Replace Documents</label>
                    <div class="row g-3">
                ...
                <div class="step-pane" id="pane-5" data-title="Schedule & Specializations" data-desc="Configure booking availability, working days/hours, and medical specialties.">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3 p-3 bg-light rounded">
                                <label class="form-check form-switch m-0">
                                    <input class="form-check-input" type="checkbox" name="is_available" value="1" id="is_available_check"
                                        {{ old('is_available', $user->nurseProfile->is_available ?? false) ? 'checked' : '' }} />
                                    ...
                                    @foreach($days as $val => $label)
                                        <label class="form-selectgroup-item">
                                            <input type="checkbox" name="available_days[]" value="{{ $val }}"
                                                class="form-selectgroup-input" {{ in_array($val, $selectedDays) ? 'checked' : '' }} />
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="time" name="available_from" class="form-control @error('available_from') is-invalid @enderror"
                                            value="{{ old('available_from', $user->nurseProfile->available_from ? \Carbon\Carbon::parse($user->nurseProfile->available_from)->format('H:i') : '') }}" />
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="time" name="available_to" class="form-control @error('available_to') is-invalid @enderror"
                                            value="{{ old('available_to', $user->nurseProfile->available_to ? \Carbon\Carbon::parse($user->nurseProfile->available_to)->format('H:i') : '') }}" />
                                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            @php
                                $selectedCareTypes = old('care_types', $user->nurseProfile ? $user->nurseProfile->careTypes->pluck('id')->toArray() : []);
                                if (!is_array($selectedCareTypes)) $selectedCareTypes = [];
                            @endphp
                                ...
                                @foreach($careTypes as $careType)
                                    <label class="form-selectgroup-item">
                                        <input type="checkbox" name="care_types[]" value="{{ $careType->id }}"
                                            ...
                                            {{ in_array($careType->id, $selectedCareTypes) ? 'checked' : '' }} />
...
<script>
    $(document).ready(function() {
        ...
        // Repeater — Experience
        let expIndex = {{ count($oldExperiences) }};
        ...
        $(document).on('click', '.remove-existing-doc', function() {
            if (confirm('Are you sure you want to remove this document? It will be permanently detached upon saving.')) {
