    ...
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Deleted Nurses</h2>
            </div>
            <div class="col-auto">
    ...
    <script>
        $(function () {
            ...
            var table = $('#nurses-table').DataTable({
                serverSide: true,
                processing: false,
                ajax: { url: '{{ route('admin.nurses.deleted.data') }}' },
                columns: [
                ...
                language: {
                    ...
                    zeroRecords: ' ',
                    loadingRecords: ' ',
                    info: 'Showing _START_–_END_ of _TOTAL_ deleted nurses',
                    infoEmpty: 'No deleted nurses to show',
                    ...
                    $.post('/admin/nurses/' + id + '/restore', { _token: '{{ csrf_token() }}' })
                        .done(function () { 
                            ...
                            Swal.fire({
                                ...
                                timer: 1500,
                                icon: 'success',
                                title: 'Nurse restored successfully'
                            });
                        })
                        .fail(function () { 
                            Swal.fire({
