    ...
    <div class="page-header d-print-none mb-4">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Pending Approval</h2>
            </div>
            <div class="col-auto">
        ...
        $(function () {
            ...
            var table = $('#nurses-table').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: ' ',
                    loadingRecords: ' ',
                    info: 'Showing _START_–_END_ of _TOTAL_ pending applications',
                    infoEmpty: 'No pending applications to show',
            ...
            $(document).on('click', '.btn-delete', function () {
                var id = $(this).data('id');
                Swal.fire({
                    title: 'Delete Nurse Application?',
