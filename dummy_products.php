...
$products = [
    ...
    [
        'category_id' => 9, // Women's Clothing
    ...
    [
        'category_id' => 10, // Kids' Wear
        'name' => 'Boys Party Wear Suit Set',
...
foreach ($products as $data) {
    ...
    // ensure slug is unique by appending random chars just in case
